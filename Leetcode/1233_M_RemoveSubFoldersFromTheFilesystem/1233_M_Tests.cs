...
public class Test {
    ...
    public void SanityTest() {
        string[] folder = new[] { "/a", "/a/b", "/c/d", "/c/d/e", "/c/f" };
    ...
    public void SanityTest_02() {
        string[] folder = new[] { "/a", "/a/b/c", "/a/b/d" };
    ...
    public void SanityTest_03() {
        string[] folder = new[] { "/a/b/c", "/a/b/ca", "/a/b/d" };
    ...
    public void SanityTest_04() {
        string[] folder = new[] { "/a/b/c", "/a/b/ca", "/a/b/d", "/a" };
        List<string> correct = new List<string> { "/a" };
        MainTest(folder, correct);
    }
    ...
    public void SanityTest_05() {
        string[] folder = new[] { "/a/b/c", "/a/b/ca", "/a/b/d", "/a/b" };
